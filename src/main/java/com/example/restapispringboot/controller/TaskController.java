...
import com.example.restapispringboot.requests.CreateTaskInput;
import com.example.restapispringboot.requests.UpdateTaskInput;
import com.example.restapispringboot.services.TaskService;
...
public class TaskController {
    ...
    public ResponseEntity<Task> oneTask(@PathVariable int id) {
        ...
        if (((Optional<?>) optionalTask).isPresent()) {
